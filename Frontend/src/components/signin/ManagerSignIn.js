...
export default function ManagerSignIn(props) {
  ...
  useEffect(() => {
    axios.get('http://localhost:8081/managerLogin', {
      params: {
        managerId: managerId,
        password: password
      }
...
//     managerLogin=()=>{
//         var managerId = document.forms["managerSignInForm"]["managerId"].value;
//         var password = document.forms["managerSignInForm"]["password"].value;   
//         axios.get(`http://localhost:8080/managerLogin/${managerId}/${password}`).then((response)=>{
...
//         return(
//             <div>
//                 <form name="managerSignInForm" action="/managerHome" onSubmit={this.managerLogin}>
//                     <h2 className = "text-center">Please Sign In</h2>
//                     <div className="form-group input-group">
//                         <div className="input-group-prepend">
//                             <div className="input-group-text">
