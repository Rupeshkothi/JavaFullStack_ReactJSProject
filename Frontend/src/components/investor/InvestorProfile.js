...
export default function InvestorProfile({match}) {
    ...
    useEffect(() => {
        axios.get('http://localhost:8081/getInvestor', {
            params: {
...
//         return(
        ...
        //                 <div className="container">
        //                     <h2 id="managerprofile">Profile
        //                         <Link className="btn text-primary" to="/updateInvestor">
        //                             <i className="fas fa-pencil-alt"></i>
        //                         </Link>
        //                     </h2>
        //                     <div className="col-md-7 container" id="managerProfile">
        ...
        //                                     </div>
        //                                 </div>
        //                                 <input className="form-control" placeholder="1" name="investorId" id="investorId"
        ...
        //                                     </div>
        //                                 </div>
        //                                 <input type="text" className="form-control" placeholder="Akshay Sutar" name="investorName" id="investorName"
        //                                     pattern="[A-z][a-z]*+\\s[A-z][a-z]*+" title="Fullname should only have only alphabets and firstname and lastname" required />
        //                             </div>
        //                             <label for="email">Email</label>
        //                             <div className="form-group input-group">
        //                                 <div className="input-group-prepend">
        ...
        //                                     </div>
        //                                 </div>
        //                                 <input type="email" className="form-control" placeholder="akshay@gmail.com" name="email" id="email"
        //                                     title="(Ex:abc@gmail.com)" required/>
        //                             </div>
        //                             <label for="mobileNo">Mobile No</label>
        //                             <div className="form-group input-group">
        //                                 <div className="input-group-prepend">
        ...
        //                                     </div>
        //                                 </div>
        //                                 <input className="form-control" placeholder="State Bank Of India" name="bankName" id="bankName"
        ...
        //                                     </div>
        //                                 </div>
        //                                 <input className="form-control" placeholder="Ichalkaranji" name="branchName" id="branchName"
        //                                     pattern="^[a-zA-Z]+$" title="Bank branch name should only have only alphabets"  required/>
        //                             </div>
        //                             <label for="accountNo">Account No</label>
        //                             <div className="form-group input-group ">
        //                                 <div className="input-group-prepend">
        ...
        //                                     </div>
        //                                 </div>
        //                                 <input className="form-control" placeholder="201500575012" name="accountNo" id="accountNo"
        //                                     pattern="[0-9]{12}" title="Account number should have only numbers" required/>
        //                             </div>
        //                             <label for="bankBalance">Bank Balance</label>
        //                             <div className="form-group input-group">
        //                                 <div className="input-group-prepend">
        ...
        //                                     </div>
        //                                 </div>
        //                                 <input className="form-control" placeholder="60000" name="balance" id="bankBalance" 
        //                                     title="Minimum balance should be 10,000 to create your account" required/>
        //                             </div>
        //                         </div>
        //                     </form>
        //                 </div>
