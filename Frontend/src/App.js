...
import GetStockDetails from './components/stock/GetStockDetails';
...
import SetPassword from './components/manager/SetPassword';
      ...
      <div className="row">
        <div className="col-md-12 offset-md-0">
          ...
          <switch>
            ...
            <Route path="/updateCompany" component={UpdateCompany}></Route>
            ...
            <Route path="/getStockDetails" component={GetStockDetails}></Route>
            <Route path="/managerHome" component={ManagerHome}></Route>
            {/* <Route path="/managerProfile" component={ManagerProfile}></Route> */}
            <Route exact path="/managerProfile/:managerId" component={ManagerProfile}></Route>
            {/* <Route path="/updateManager" component={UpdateManager}></Route> */}
            {/* <Route path="/updateManager" component={ManagerUpdate}></Route> */}
            ...
            <Route path="/updateStockPrice" component={UpdateStockPrice}></Route>
            {/* <Route path="/updateStockPrice/:companyId" component={UpdateStockPrice}></Route> */}
            <Route path="/investorHome" component={InvestorHome}></Route>
            {/* <Route path="/investorProfile" component={InvestorProfile}></Route> */}
            <Route path="/investorProfile/:investorId" component={InvestorProfile}></Route>
            {/* <Route path="/updateInvestor" component={UpdateInvestor}></Route> */}
